...
impl ::protobuf::Message for AuthTokens {
    ...
    fn default_instance() -> &'static AuthTokens {
        static mut instance: ::protobuf::lazy::Lazy<AuthTokens> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl Auth {
    ...
    pub fn get_tokens(&self) -> &AuthTokens {
        self.tokens.as_ref().unwrap_or_else(|| AuthTokens::default_instance())
    }
...
impl ::protobuf::Message for Auth {
    ...
    fn default_instance() -> &'static Auth {
        static mut instance: ::protobuf::lazy::Lazy<Auth> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl Secret {
    ...
    pub fn get_auth(&self) -> &Auth {
        self.auth.as_ref().unwrap_or_else(|| Auth::default_instance())
    }
